namespace UniPortal.Services.Mapping
{
    ...
    public static class AutoMapperConfig
    {
        ...
        private static IEnumerable<TypesMap> GetFromMaps(List<Type> types)
        {
        ...
        private static IEnumerable<TypesMap> GetToMaps(List<Type> types)
        {
        ...
        private static IEnumerable<IHaveCustomMappings> GetCustomMappings(List<Type> types)
        {
